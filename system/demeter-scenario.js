...
},music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[405]},[
["あれまあ、あとがきを最初に読んじゃう",["種別","タイプ"],"の人類だわね。"],
["妾","もそういう","類","だから、判るよ。"],
["って、まあ、人類じゃないかもだけどね、","妾","達。"],
]],
// index: 405
[{speaker:"danu",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[406]},[
["自由ラジオ横濱",["前線","フロント"],"。"],
["あらためまして、おはこんばんちは。"],
["気高き","天の女王、ダヌーさんだよ。"],
["で、","貴方","、誰。"],
...
// index: 406
[{speaker:"author",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[407]},[
["よお。"],
]],
// index: 407
[{speaker:"danu",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[408]},[
["そうきたか。"],
]],
// index: 408
[{speaker:"author",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[409]},[
["……どうでも","いい","が、あとがきで作者が登場人物と会話をするって、ジュブナイルの基本やよな。"],
]],
// index: 409
[{speaker:"danu",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[410]},[
["面倒だからいちいち突っ込まないぞ。"],
]],
// index: 410
[{speaker:"author",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[411]},[
["私淑する作家は、","ろくごまるにと","ぶらじま","太郎です。"],
]],
// index: 411
[{speaker:"danu",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[412]},[
["そこで、タイラーとかスレイヤーズとか挙げられないところが、","貴方","達の限界だわよ。"],
]],
// index: 412
[{speaker:"author",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[413]},[
["その","『——だわよ』","口調は、","『レッツゴー怪奇組』","組長口調というんだぜ。"],
]],
// index: 413
[{speaker:"danu",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[414]},[
["こすってくるなあ。"],
["企画書には、黒歴史ラジオの風体でコメンタリーしたいって書いてあったけど。"],
]],
// index: 414
[{speaker:"author",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[415]},[
["実は、君の名は","『真・女神転生V』","に由来する。"],
]],
// index: 415
[{speaker:"danu",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[416]},[
["実はもなんも、","STEVEN","がでてきた時点で、読者諸賢はおさっしだわよ。"],
]],
// index: 416
[{speaker:"author",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[417]},[
["実は、メサイア会のモデルは、イエズス会。"],
]],
// index: 417
[{speaker:"danu",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[418]},[
["それは、まあ、ね。"],
["けど、いいの。"],
["AK","遣うくらいなら、",["素手","ステゴロ"],"すんのがあ",["奴","いつ"],"らでしょ。"],
]],
// index: 418
[{speaker:"author",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[419]},[
[["偽史","フィクション"],"だからね、どこまでいってもさ。"],
]],
// index: 419
[{speaker:"danu",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[420]},[
["原子爆弾以外は。"],
]],
// index: 420
[{speaker:"author",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[421]},[
["そりゃあそうさ。"],
]],
// index: 421
[{speaker:"danu",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[422]},[
["で、どうなの。"],
["方向性とか、そういうの。"],
]],
// index: 422
[{speaker:"author",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[423]},[
["『昭和米国物語』","のコンセプトに、",["屍者","ゾンビ"],"と",["怪獣","カイジュー"],"とロボってあってさ、ロボまでたどりつけなかったんだよね。"],
["黄色い会社はその痕跡なわけだけど。"],
]],
// index: 423
[{speaker:"danu",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[424]},[
["ビーンボール、投げてくれんじゃん。"],
["まあ、そんなかんじでネタばらしをしていくわけだよね。"],
["んじゃ、チャンネル登録よろしくおなしゃす——"],
]],
// index: 424
[{speaker:"narrator",finish:"title",music:"star_guardian03",place:"壁にかこまれた街",background:"モノクローム",adjacencies:[]},[
