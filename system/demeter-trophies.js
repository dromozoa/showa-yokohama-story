...
{key:"orientation",name:"ラブリー",description:"縦長画面と横長画面を両方表示した。"},
{key:"kcode",name:"強い気持ち・強い愛",description:"タイトル画面でコナミコマンドを入力した。"},
{key:"elvis",name:"WOW WAR TONIGHT",description:"最熱望を択んだ。"},
...
{key:"doe",name:"残酷な天使のテーゼ",description:"アリスの父親の名前を択ばずに予告を見た。"},
