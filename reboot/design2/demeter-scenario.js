...
{choice:["サム・スペード"],action:($,ctx)=>{ctx.game.father = 1;;},barcode:"Sam Spade",label:27},
{choice:["フィリップ・マーロウ"],action:($,ctx)=>{ctx.game.father = 2;;},barcode:"Philip Marlowe",label:27},
{choice:["マイク・ハマー"],action:($,ctx)=>{ctx.game.father = 3;;},barcode:"Mike Hammer",label:27},
],music:"diana33"},[
["年季のはいったガヴァメントだ。"],
["刻印がある。"],
["そうか。そういうことか。"],
...
// index:52
[{speaker:"alice",choices:[
{choice:["ある"],barcode:"Yes ma'am!",label:53},
{choice:["ない"],barcode:"No ma'am!",label:54},
],music:"diana33"},[
["さてと。"],
["スティーブンと呼ばれた人物、あるいは結社の噂を聞いたことがあるか。"],
]],
// index:53
[{speaker:"alice",jump:55,music:"diana33"},[
["そうだ。飽きるほど囁かれた噂だ。"],
...
{choice:["本牧",["大聖堂","カテドラル"]],barcode:"priest",label:64},
{choice:["資源循環局"],barcode:"engineer",label:88},
{choice:["魚人港湾労働組合"],barcode:"activist",label:119},
],when:($,ctx)=>{
if($.priest && $.engineer && $.activist)return 159;
},music:"diana19"},[
["少尉、どこに手紙を届けるの。"],
]],
// index:64
...
// index:86
[{speaker:"narrator",jump:63,music:"diana19"},[
["神父が歩み去る。"],
...
// index:87
[{speaker:"danu",jump:63,music:"diana19"},[
[["大聖堂","カテドラル"],"は行ったじゃん。"],
]],
// index:88
[{speaker:"danu",when:($,ctx)=>{
if($.engineer)return 118;
...
// index:120
[{speaker:"narrator",jump:122,when:($,ctx)=>{
if(ctx.system.unionSetting === "ろうくみ")return 121;
},music:"diana19"},[
["入口のかたわらにベニヤ看板。"],
["角ばった字で、魚人港湾労組。"],
["ポリ塩化ビニル暖簾を、キミはくぐった。"],
...
// index:167
[{speaker:"alice",choices:[
{choice:["熱望"],barcode:"Elvis",label:168},
{choice:["希望"],barcode:"Elpis",label:169},
{choice:["拒否"],label:171},
],music:"diana19"},[
["強制はしない、少尉。"],
["熱望か希望か拒否か、ひとつを択べ。"],
...
// index:168
[{speaker:"danu",jump:182,music:"diana19"},[
["安心して。"],
...
// index:170
[{speaker:"danu",choices:[
{choice:["最熱望"],barcode:"Elvis",label:168},
{choice:["熱望"],barcode:"Elvis",label:168},
{choice:["拒否"],label:171},
],music:"diana19"},[
[["妖精","エルブズ"],"はいるけど。"],
...
{choice:["エデンの園"],action:($,ctx)=>{$.genesis = false;;},barcode:"Garden of Eden",label:292},
{choice:["グライダー",["銃","ガン"]],action:($,ctx)=>{$.genesis = true;;},barcode:"Glider Gun",label:293},
{choice:["択ばない"],label:294},
],music:"diana23"},[
["人間が読め。"],
["人間が択べ。"],
["配置を択べ。"],
...
// index:292
[{speaker:"demeter",jump:304,music:"diana23"},[
["エデンの","園","配置が活性化。"],
[["読取専用","ROM"],"構造物を展開。"],
]],
// index:293
...
// index:350
[{speaker:"demeter",jump:353,when:($,ctx)=>{
if(ctx.game.father === 1)return 351;
if(ctx.game.father === 3)return 352;
},music:"diana21"},[
["先輩のお父さんは、フィリップ・マーロウを名乗っていて。"],
["お母さんも、ソウルネームを持ってたんですか。"],
]],
// index:351
[{speaker:"demeter",jump:353,music:"diana21"},[
...
dialogs:{
"system-reset-system":355,
"system-reset-save":356,
"load-tape-select":357,
"load-tape-tutorial":358,
"load-tape-broken":359,
"load-tape-preview":360,
"load-tape-save1":361,
"load-tape-save2":362,
"load-tape-save3":363,
"load-tape-empty":364,
