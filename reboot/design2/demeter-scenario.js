...
if($.priest && $.engineer && $.activist)return 152;
},music:"diana19"},[
["少尉、どこに手紙を届けるの。"],
]],
// index:58
...
// index:160
[{speaker:"alice",choices:[
{choice:["熱望"],barcode:"Elvis",label:161},
{choice:["希望"],barcode:"Elpis",label:162},
{choice:["拒否"],label:164},
],music:"diana19"},[
["強制はしない、少尉。"],
["熱望か希望か拒否か、ひとつを択べ。"],
...
// index:161
[{speaker:"danu",jump:175,music:"diana19"},[
["安心して。"],
...
// index:163
[{speaker:"danu",choices:[
{choice:["最熱望"],barcode:"Elvis",label:161},
{choice:["熱望"],barcode:"Elvis",label:161},
{choice:["拒否"],label:164},
],music:"diana19"},[
[["妖精","エルブズ"],"はいるけど。"],
...
{choice:["エデンの園"],action:($,ctx)=>{$.genesis = false;;},barcode:"Garden of Eden",label:285},
{choice:["グライダー",["銃","ガン"]],action:($,ctx)=>{$.genesis = true;;},barcode:"Glider Gun",label:286},
{choice:["択ばない"],label:287},
],music:"diana23"},[
["人間が読め。"],
["人間が択べ。"],
["配置を択べ。"],
...
// index:285
[{speaker:"demeter",jump:297,music:"diana23"},[
["エデンの","園","配置が活性化。"],
[["読取専用","ROM"],"構造物を展開。"],
]],
// index:286
