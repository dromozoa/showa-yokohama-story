...
// index:9
[{speaker:"narrator",jump:12,music:"vi03",place:"ここではないどこか"},[
["胸糞の悪い問題を出して、ごめん。"],
...
// index:17
[{speaker:"narrator",finish:"title",music:"vi03",place:"ここではないどこか"},[
["それじゃあ、良き、終末を。"],
]],
// index:18
[{speaker:"narrator",start:"verse1",music:"diana33",place:"横濱"},[
["昭和七十四年七月、ボクはキミに出逢った。"],
["人類が滅亡するまでの、最期のひとつきの、これは物語だ。"],
]],
// index:19
[{speaker:"narrator",music:"diana33",place:"横濱"},[
[["破局","カタストロフ"],"から十年。"],
...
// index:24
[{speaker:"yukio",music:"diana33",place:"横濱"},[
["決戦の噂、聞いたか。"],
["本牧埠頭に大量の物資が陸揚げされてる。"],
["猿島","には重砲まで持ちこんでるんだとさ。"],
...
// index:28
[{speaker:"alice",music:"diana33",place:"横濱"},[
["資源調達師団特殊検索群、アリス大佐だ。"],
["これは辞令。こっちは階級章。"],
["特殊検索群少尉に任ずる、ってね。"],
["たった今から、キミはボクの部下だ。"],
...
// index:33
[{speaker:"danu",music:"diana33",place:"横濱"},[
["ダヌーだよ。"],
["よろー。"],
["少尉、よろしくありますか。"],
]],
...
// index:57
[{speaker:"alice",jump:59,music:"diana33",place:"横濱"},[
["そうだ。飽きるほど囁かれた噂だ。"],
...
[{speaker:"narrator",enter:($,ctx)=>{ctx.game.visitedVerse2 = true;},leave:($,ctx)=>{delete $.priest;
  delete $.engineer;
  delete $.activist;;},start:"verse2",music:"diana19",place:"横濱"},[
["昭和七十四年七月、ボクはキミに出逢った。"],
["人類が滅亡するまでの、最期のひとつきの、これは物語だ。"],
]],
// index:66
[{speaker:"alice",music:"diana19",place:"横濱"},[
["キミには三通の手紙を届けてもらう。"],
["本牧",["大聖堂","カテドラル"],"。"],
["資源循環局。"],
["魚人港湾労働組合。"],
...
},music:"diana19",place:"横濱"},[
["少尉、どこに手紙を届けるの。"],
]],
// index:68
[{speaker:"narrator",when:($,ctx)=>{
if($.priest)return 91;
},leave:($,ctx)=>{$.priest = true;},music:"diana19",place:"横濱"},[
["本牧",["大聖堂","カテドラル"],"。"],
["徳川軍政時代末期、居留地に献堂された近代日本最初のメシア教会。"],
["関東大震災で崩壊し、現在の場所に移転した。"],
]],
// index:69
[{speaker:"danu",music:"diana19",place:"横濱"},[
["メサイア会かぁ。"],
["苦手なんだよね。"],
["アタシたち、",["無原罪","シンレス"],"だから。"],
]],
...
// index:71
[{speaker:"narrator",music:"diana19",place:"横濱"},[
...
// index:73
[{speaker:"priest",music:"diana19",place:"横濱"},[
[["本山","ヴァチカン"],"は総攻撃を容認したか。"],
]],
// index:74
[{speaker:"danu",music:"diana19",place:"横濱"},[
...
// index:90
[{speaker:"narrator",jump:67,music:"diana19",place:"横濱"},[
["神父が歩み去る。"],
...
// index:91
[{speaker:"danu",jump:67,music:"diana19",place:"横濱"},[
[["大聖堂","カテドラル"],"は行ったじゃん。"],
]],
// index:92
[{speaker:"danu",when:($,ctx)=>{
if($.engineer)return 122;
},leave:($,ctx)=>{$.engineer = true;},music:"diana19",place:"横濱"},[
...
// index:101
[{speaker:"engineer",music:"diana19",place:"横濱"},[
["課長といっても、名ばかりの管理職でね。"],
...
},leave:($,ctx)=>{$.activist = true;},music:"diana19",place:"横濱"},[
["本牧異人町。"],
...
// index:126
[{speaker:"activist",music:"diana19",place:"横濱"},[
...
// index:172
[{speaker:"danu",jump:186,music:"diana19",place:"横濱"},[
["安心して。"],
...
// index:175
[{speaker:"danu",music:"diana12",place:"横濱"},[
["少尉。"],
["アンタ。"],
]],
// index:176
[{speaker:"alice",music:"diana12",place:"横濱"},[
["ダヌー軍曹、いいんだ。"],
["我々は軍隊ではない。"],
...
// index:178
[{speaker:"narrator",music:"diana12",place:"横濱"},[
["除隊したキミは、引揚船で北海道に渡る。"],
]],
// index:179
[{speaker:"narrator",music:"diana12",place:"横濱"},[
...
// index:185
[{speaker:"narrator",leave:($,ctx)=>{ctx.game.visitedRevelation2 = true;},finish:"title",music:"diana12",place:"横濱"},[
...
// index:187
[{speaker:"narrator",enter:($,ctx)=>{ctx.game.visitedVerse3 = true;},start:"verse3",music:"diana23",place:"横濱"},[
["昭和七十四年七月、ボクはキミに出逢った。"],
["人類が滅亡するまでの、最期のひとつきの、これは物語だ。"],
]],
// index:188
[{speaker:"narrator",music:"diana23",place:"横濱"},[
[["情報分隊","メイジャイ"],"。情報処理に特化した",["妖精種","エルブズ"],"の三人","組","。"],
["腕に装着した","オノ＝センダイ","のデッキをにらみ、分隊長が報告する。"],
]],
// index:189
[{speaker:"demeter",music:"diana23",place:"横濱"},[
["発、ブルーリッジ分乗特殊検索群β分遣隊。"],
["宛","、特殊検索群司令部。"],
...
// index:191
[{speaker:"alice",music:"diana23",place:"横濱"},[
["避難民を満載した原子力空母を護って、第七艦隊旗艦は沈んだ。"],
[["断章","フラグメント"],"はマリアナ海溝の藻屑と消えた。"],
["β分遣隊は護国の鬼となった。"],
]],
// index:192
[{speaker:"danu",music:"diana23",place:"横濱"},[
["十万余の",["屍者","ゾンビ"],"、国難ここに見る。"],
["昭和七十四年の夏の頃。"],
["十万だったら楽だったのに。"],
]],
...
// index:217
[{speaker:"yukio",music:"diana23",place:"横濱"},[
["呼びだしてわるかったな。"],
[["長距離哨戒","LRP"],"帰りなんだ。"],
...
// index:229
[{speaker:"priest",music:"diana23",place:"横濱"},[
["隊形を変換するか。"],
]],
// index:230
[{speaker:"alice",music:"diana23",place:"横濱"},[
...
// index:244
[{speaker:"engineer",music:"diana23",place:"横濱"},[
["ケーブルは二階まで引けばいいんだね。"],
...
// index:270
[{speaker:"steven",music:"diana23",place:"横濱"},[
["これは手紙。"],
["これは郵便。"],
["これは",["物語","ナラティブ"],"。"],
]],
...
],music:"diana23",place:"横濱"},[
["人間が読め。"],
["人間が択べ。"],
["配置を択べ。"],
]],
// index:296
[{speaker:"demeter",jump:308,music:"diana23",place:"横濱"},[
["エデンの","園","配置が活性化。"],
[["読取専用","ROM"],"構造物を展開。"],
]],
// index:297
...
// index:307
[{speaker:"narrator",leave:($,ctx)=>{ctx.game.visitedRevelation3 = true;},finish:"credits",music:"diana12",place:"横濱"},[
["昭和横濱物語。アリスの",["黙示録","リベレーション"],"。"],
["了。"],
]],
// index:308
...
// index:314
[{speaker:"activist",music:"diana23",place:"横濱"},[
["良い報せと悪い報せがある。"],
["良い報せだ。魚人の多数派工作は成功した。"],
...
},music:"diana12",place:"横濱"},[
["世界は書きかわるのか。"],
["あるいは、すでに書きかわったのか。"],
]],
// index:324
[{speaker:"demeter",music:"diana12",place:"横濱"},[
["えっと、書きかわりつつある、たぶん。"],
...
[{speaker:"narrator",leave:($,ctx)=>{ctx.game.visitedGospel = true;
  ctx.game.unlockPreview = true;;},finish:"credits",music:"diana12",place:"横濱"},[
["昭和横濱物語。スティーブンによる福音書。最終節。"],
["了。"],
]],
// index:341
...
// index:347
[{speaker:"priest",music:"diana12",place:"横濱"},[
["困りはしないぞ。"],
["メシア教はそんなに甘い宗教ではない。"],
["他の宗教のことは知らんが、な。"],
]],
...
// index:350
[{speaker:"narrator",leave:($,ctx)=>{ctx.game.visitedGenesis = true;},finish:"credits",music:"diana12",place:"横濱"},[
["昭和横濱物語。アリスの",["創世記","ジェネシス"],"。"],
["了。"],
]],
// index:351
[{speaker:"narrator",music:"diana21",place:"横濱"},[
["文芸部の部室。"],
["壊れかけの黒いラジオから、頭脳警察が流れている。"],
["都市地図が広げられた",["卓子","テーブル"],"を囲む少女たち。"],
]],
// index:352
[{speaker:"danu",music:"diana21",place:"横濱"},[
["ねえ、アリス。"],
["パパがいたってことはさ。"],
["アリスには、ママもいたわけだよね。"],
]],
// index:353
[{speaker:"alice",music:"diana21",place:"横濱"},[
["このセカイが道理をわきまえているならば。"],
["そんなことは、期待するべくもないが。"],
]],
// index:354
...
},music:"diana21",place:"横濱"},[
["先輩のお父さんって、フィリップ・マーロウを名乗ってたんでしたっけ。"],
["お母さんも、ダサい",["偽名","ソウルネーム"],"を持ってたんですか","。"],
]],
// index:355
[{speaker:"demeter",jump:357,music:"diana21",place:"横濱"},[
...
// index:358
[{speaker:"demeter",music:"diana21",place:"横濱"},[
["屍都の女王もたいがい。"],
]],
// index:359
[{speaker:"alice",music:"diana21",place:"横濱"},[
...
// index:367
[{speaker:"rosa",start:"preview",music:"diana21",place:"横濱"},[
["こちらは、自由ラジオ横濱",["前線","フロント"],"。"],
["ライシャワーが死んだセカイ線、バリケードの裡から、あの山岳",["根拠地","ベース"],"で産まれてしまった子供たちへ。"],
["聴こえてるかな。"],
]],
// index:368
[{speaker:"rosa",music:"diana21",place:"横濱"},[
...
// index:371
[{speaker:"narrator",leave:($,ctx)=>{ctx.game.visitedSixtyNine = true;},finish:"title",music:"diana21",place:"横濱"},[
