...
{choice:["サム・スペード"],action:($,ctx)=>{$.father = 1;;},barcode:"Sam Spade",label:18},
{choice:["フィリップ・マーロウ"],action:($,ctx)=>{$.father = 2;;},barcode:"Philip Marlowe",label:18},
{choice:["マイク・ハマー"],action:($,ctx)=>{$.father = 3;;},barcode:"Mike Hammer",label:18},
],music:"diana33"},[
["年季のはいったガヴァメントだ。"],
["刻印がある。"],
["そうか。そういうことか。"],
...
// index:43
[{speaker:"alice",choices:[
{choice:["ある"],barcode:"Yes ma'am!",label:44},
{choice:["ない"],barcode:"No ma'am!",label:45},
],music:"diana33"},[
["さてと。"],
["スティーブンと呼ばれた人物、あるいは結社の噂を聞いたことがあるか。"],
]],
// index:44
[{speaker:"alice",jump:46,music:"diana33"},[
["そうだ。飽きるほど囁かれた噂だ。"],
...
{choice:["本牧",["大聖堂","カテドラル"]],barcode:"priest",label:55},
{choice:["資源循環局"],barcode:"engineer",label:79},
{choice:["魚人港湾労働組合"],barcode:"activist",label:110},
],when:($,ctx)=>{
if($.priest && $.engineer && $.activist)return 149;
},music:"diana19"},[
["少尉、どこに手紙を届けるの。"],
]],
// index:55
...
// index:77
[{speaker:"narrator",jump:54,music:"diana19"},[
["神父が歩み去る。"],
...
// index:78
[{speaker:"danu",jump:54,music:"diana19"},[
[["大聖堂","カテドラル"],"は行ったじゃん。"],
]],
// index:79
[{speaker:"danu",when:($,ctx)=>{
if($.engineer)return 109;
...
// index:157
[{speaker:"alice",choices:[
{choice:["熱望"],barcode:"Elvis",label:158},
{choice:["希望"],barcode:"Elpis",label:159},
{choice:["拒否"],label:161},
],music:"diana19"},[
["強制はしない、少尉。"],
["熱望か希望か拒否か、ひとつを択べ。"],
...
// index:158
[{speaker:"danu",jump:172,music:"diana19"},[
["安心して。"],
...
// index:160
[{speaker:"danu",choices:[
{choice:["最熱望"],barcode:"Elvis",label:158},
{choice:["熱望"],barcode:"Elvis",label:158},
{choice:["拒否"],label:161},
],music:"diana19"},[
[["妖精","エルブズ"],"はいるけど。"],
...
{choice:["エデンの園"],action:($,ctx)=>{$.genesis = false;;},barcode:"Garden of Eden",label:282},
{choice:["グライダー",["銃","ガン"]],action:($,ctx)=>{$.genesis = true;;},barcode:"Glider Gun",label:283},
{choice:["択ばない"],label:284},
],music:"diana23"},[
["人間が読め。"],
["人間が択べ。"],
["配置を択べ。"],
...
// index:282
[{speaker:"demeter",jump:294,music:"diana23"},[
["エデンの","園","配置が活性化。"],
[["読取専用","ROM"],"構造物を展開。"],
]],
// index:283
