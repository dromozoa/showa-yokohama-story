...
// index:9
[{speaker:"narrator",jump:12,music:"vi03",place:"ここではない、どこか"},[
["胸糞の悪い問題を出して、ごめん。"],
...
// index:17
[{speaker:"narrator",finish:"title",music:"vi03",place:"ここではない、どこか"},[
["それじゃあ、良き、終末を。"],
]],
// index:18
[{speaker:"narrator",start:"verse1",music:"diana33",place:"日本"},[
["昭和七十四年七月、ボクはキミに出逢った。"],
["人類が滅亡するまでの、最期のひとつきの、これは物語だ。"],
]],
// index:19
[{speaker:"narrator",music:"diana33",place:"日本"},[
[["破局","カタストロフ"],"から十年。"],
...
// index:22
[{speaker:"narrator",music:"diana33",place:"本牧地区"},[
...
// index:24
[{speaker:"yukio",music:"diana33",place:"本牧地区"},[
["決戦の噂、聞いたか。"],
["本牧埠頭に大量の物資が陸揚げされてる。"],
["猿島","には重砲まで持ちこんでるんだとさ。"],
...
// index:25
[{speaker:"narrator",music:"diana33",place:"本牧南小学校跡"},[
["その日は",["屍者","ゾンビ"],"にも不審者にも遭遇しなかった。"],
["本部が置かれた小学校に戻り、下番したキミに大隊幕僚が声をかけた。"],
["キミを訪ねてきた者がいるという。"],
]],
// index:26
[{speaker:"yukio",music:"diana33",place:"本牧南小学校跡"},[
["おい、あれ、魔人小隊じゃねえか。"],
...
// index:28
[{speaker:"alice",music:"diana33",place:"本牧南小学校跡"},[
["資源調達師団特殊検索群、アリス大佐だ。"],
["これは辞令。こっちは階級章。"],
["特殊検索群少尉に任ずる、ってね。"],
["たった今から、キミはボクの部下だ。"],
...
// index:33
[{speaker:"danu",music:"diana33",place:"本牧南小学校跡"},[
["ダヌーだよ。"],
["よろー。"],
["少尉、よろしくありますか。"],
]],
...
// index:36
[{speaker:"narrator",music:"diana33",place:"本牧異人町"},[
...
// index:38
[{speaker:"alice",music:"diana33",place:"本牧異人町"},[
["α分遣隊にようこそ、少尉。"],
...
// index:41
[{speaker:"danu",music:"diana33",place:"本牧異人町"},[
[["超ムカつく","チョムカ"],"。"],
["ありがたくあります。"],
]],
// index:42
...
],music:"diana33",place:"本牧異人町"},[
["さてと。"],
["スティーブンと呼ばれた人物、あるいは結社の噂を聞いたことがあるか。"],
]],
// index:57
[{speaker:"alice",jump:59,music:"diana33",place:"本牧異人町"},[
["そうだ。飽きるほど囁かれた噂だ。"],
...
[{speaker:"narrator",enter:($,ctx)=>{ctx.game.visitedVerse2 = true;},leave:($,ctx)=>{delete $.priest;
  delete $.engineer;
  delete $.activist;;},start:"verse2",music:"diana19",place:"本牧異人町"},[
["昭和七十四年七月、ボクはキミに出逢った。"],
["人類が滅亡するまでの、最期のひとつきの、これは物語だ。"],
]],
// index:66
[{speaker:"alice",music:"diana19",place:"本牧異人町"},[
["キミには三通の手紙を届けてもらう。"],
["本牧",["大聖堂","カテドラル"],"。"],
["資源循環局。"],
["魚人港湾労働組合。"],
...
},music:"diana19",place:"本牧異人町"},[
["少尉、どこに手紙を届けるの。"],
]],
// index:68
[{speaker:"narrator",when:($,ctx)=>{
if($.priest)return 91;
},leave:($,ctx)=>{$.priest = true;},music:"diana19",place:"本牧大聖堂"},[
["本牧",["大聖堂","カテドラル"],"。"],
["徳川軍政時代末期、居留地に献堂された近代日本最初のメシア教会。"],
["関東大震災で崩壊し、現在の場所に移転した。"],
]],
// index:69
[{speaker:"danu",music:"diana19",place:"本牧大聖堂"},[
["メサイア会かぁ。"],
["苦手なんだよね。"],
["アタシたち、",["無原罪","シンレス"],"だから。"],
]],
...
// index:71
[{speaker:"narrator",music:"diana19",place:"本牧大聖堂"},[
...
// index:73
[{speaker:"priest",music:"diana19",place:"本牧大聖堂"},[
[["本山","ヴァチカン"],"は総攻撃を容認したか。"],
]],
// index:74
[{speaker:"danu",music:"diana19",place:"本牧大聖堂"},[
...
// index:90
[{speaker:"narrator",jump:67,music:"diana19",place:"本牧大聖堂"},[
["神父が歩み去る。"],
...
// index:91
[{speaker:"danu",jump:67,music:"diana19",place:"本牧大聖堂"},[
[["大聖堂","カテドラル"],"は行ったじゃん。"],
]],
// index:92
[{speaker:"danu",when:($,ctx)=>{
if($.engineer)return 122;
},leave:($,ctx)=>{$.engineer = true;},music:"diana19",place:"横濱本牧駅"},[
...
// index:93
[{speaker:"danu",music:"diana19",place:"横濱本牧駅"},[
...
// index:99
[{speaker:"narrator",music:"diana19",place:"資源循環局"},[
["武装臨海鉄道、本牧線、横濱本牧駅。"],
...
// index:101
[{speaker:"engineer",music:"diana19",place:"資源循環局"},[
["課長といっても、名ばかりの管理職でね。"],
...
// index:103
[{speaker:"danu",music:"diana19",place:"資源循環局"},[
["大隊","十基数","、用意してる。"],
]],
// index:104
[{speaker:"engineer",music:"diana19",place:"資源循環局"},[
...
// index:121
[{speaker:"narrator",jump:67,music:"diana19",place:"資源循環局"},[
["応えはなかった。"],
["応えは求められていなかった。"],
[["珈非","コーヒ"],"を飲みほして、キミは席を立った。"],
]],
// index:122
[{speaker:"danu",jump:67,music:"diana19",place:"横濱本牧駅"},[
["資源循環局は、もう行ったよね。"],
]],
// index:123
[{speaker:"narrator",when:($,ctx)=>{
if($.activist)return 162;
},leave:($,ctx)=>{$.activist = true;},music:"diana19",place:"魚人港湾労組"},[
["本牧異人町。"],
...
},music:"diana19",place:"魚人港湾労組"},[
["入口のかたわらにベニヤ看板。"],
["角ばった字で、魚人港湾労組。"],
["ポリ塩化ビニル暖簾を、キミはくぐった。"],
]],
// index:125
[{speaker:"narrator",music:"diana19",place:"魚人港湾労組"},[
["入口のかたわらにベニヤ看板。"],
["角ばった字で、魚人港湾","労組","。"],
["ポリ塩化ビニル暖簾を、キミはくぐった。"],
]],
// index:126
[{speaker:"activist",music:"diana19",place:"魚人港湾労組"},[
["おまえさん、",["探偵","ピンカートン"],"の弟子か。"],
["ピケやぶりなら帰ってくれ。"],
]],
// index:127
[{speaker:"danu",music:"diana19",place:"魚人港湾労組"},[
["どっちかっていうと、ボス交。"],
]],
// index:128
[{speaker:"activist",music:"diana19",place:"魚人港湾労組"},[
...
// index:161
[{speaker:"narrator",jump:67,music:"diana19",place:"魚人港湾労組"},[
["フィルタつき",["叶和圓","イェヘユアン"],"のカートンをキミは受けとる。"],
["ダヌーは古い歌をハミングした。"],
["ただよう臭いが煙草のせいなのかどうか、キミにはわからなかった。"],
]],
// index:162
[{speaker:"danu",jump:67,music:"diana19",place:"魚人港湾労組"},[
["手紙は届けられてしまったよ、すでに。"],
]],
// index:163
[{speaker:"danu",music:"diana19",place:"三溪園"},[
["少尉、今日の配給。"],
["本物の肉を使った肉まんだって。"],
]],
// index:164
[{speaker:"narrator",music:"diana19",place:"三溪園"},[
...
// index:166
[{speaker:"narrator",music:"diana19",place:"本牧異人町"},[
["特殊検索群α分遣隊の総員が指揮所に集合した。"],
]],
// index:167
[{speaker:"danu",music:"diana19",place:"本牧異人町"},[
["傾聴。"],
]],
// index:168
[{speaker:"alice",music:"diana19",place:"本牧異人町"},[
...
// index:172
[{speaker:"danu",jump:186,music:"diana19",place:"本牧異人町"},[
["安心して。"],
...
// index:175
[{speaker:"danu",music:"diana12",place:"本牧異人町"},[
["少尉。"],
["アンタ。"],
]],
// index:176
[{speaker:"alice",music:"diana12",place:"本牧異人町"},[
["ダヌー軍曹、いいんだ。"],
["我々は軍隊ではない。"],
...
// index:178
[{speaker:"narrator",music:"diana12",place:"苫小牧"},[
["除隊したキミは、引揚船で北海道に渡る。"],
]],
// index:179
[{speaker:"narrator",music:"diana12",place:"苫小牧"},[
...
// index:182
[{speaker:"narrator",music:"diana12",place:"南樺太"},[
["南樺太。"],
["炭鉱労働を終えたキミは帰路につく。"],
...
// index:184
[{speaker:"alice",music:"diana12",place:"南樺太"},[
["返してもらいにきた。その銃を。"],
["終わらせにきた。人類を。世界を。"],
["——昭和を。"],
]],
// index:185
[{speaker:"narrator",leave:($,ctx)=>{ctx.game.visitedRevelation2 = true;},finish:"title",music:"diana12",place:"南樺太"},[
...
// index:187
[{speaker:"narrator",enter:($,ctx)=>{ctx.game.visitedVerse3 = true;},start:"verse3",music:"diana23",place:"本牧異人町"},[
["昭和七十四年七月、ボクはキミに出逢った。"],
["人類が滅亡するまでの、最期のひとつきの、これは物語だ。"],
]],
// index:188
[{speaker:"narrator",music:"diana23",place:"本牧異人町"},[
[["情報分隊","メイジャイ"],"。情報処理に特化した",["妖精種","エルブズ"],"の三人","組","。"],
["腕に装着した","オノ＝センダイ","のデッキをにらみ、分隊長が報告する。"],
]],
// index:189
[{speaker:"demeter",music:"diana23",place:"本牧異人町"},[
["発、ブルーリッジ分乗特殊検索群β分遣隊。"],
["宛","、特殊検索群司令部。"],
...
// index:191
[{speaker:"alice",music:"diana23",place:"本牧異人町"},[
["避難民を満載した原子力空母を護って、第七艦隊旗艦は沈んだ。"],
[["断章","フラグメント"],"はマリアナ海溝の藻屑と消えた。"],
["β分遣隊は護国の鬼となった。"],
]],
// index:192
[{speaker:"danu",music:"diana23",place:"本牧異人町"},[
["十万余の",["屍者","ゾンビ"],"、国難ここに見る。"],
["昭和七十四年の夏の頃。"],
["十万だったら楽だったのに。"],
]],
...
// index:216
[{speaker:"narrator",music:"diana23",place:"本牧大聖堂"},[
["ある夜。"],
["無名戦士の墓。"],
[["訓練士","ハンドラー"],"のユキヲが立つ。"],
["彼の犬とともに。"],
...
// index:217
[{speaker:"yukio",music:"diana23",place:"本牧大聖堂"},[
["呼びだしてわるかったな。"],
[["長距離哨戒","LRP"],"帰りなんだ。"],
...
// index:223
[{speaker:"narrator",music:"diana23",place:"湾岸線"},[
["大隊は進発した。"],
["二列縦隊で進む。"],
...
// index:228
[{speaker:"demeter",music:"diana23",place:"湾岸線"},[
["進路上に",["屍者","ゾンビ"],"、中隊規模。一個小隊欠かな。"],
]],
// index:229
[{speaker:"priest",music:"diana23",place:"湾岸線"},[
["隊形を変換するか。"],
]],
// index:230
[{speaker:"alice",music:"diana23",place:"湾岸線"},[
["無停止進撃と命じたぞ、神父。"],
["ボクが排除する。"],
]],
// index:231
[{speaker:"danu",music:"diana23",place:"湾岸線"},[
["大隊総員に達する。"],
["莫迦が単騎で突撃する。"],
["なんか、いいかんじにおなしゃす。"],
]],
...
// index:236
[{speaker:"narrator",music:"diana23",place:"一般設計学研究所"},[
["大隊は進軍した。"],
["運河を渡った。"],
["一般設計学研究所に到着した。"],
["計算機棟内を掃討する。"],
...
// index:237
[{speaker:"priest",music:"diana23",place:"一般設計学研究所"},[
["西側に",["殺し間","キルゾーン"],"を形成する。"],
["海側はどうにもならん。"],
]],
// index:238
[{speaker:"alice",music:"diana23",place:"一般設計学研究所"},[
["時間差がある。"],
["各個撃破する。"],
]],
// index:239
[{speaker:"demeter",music:"diana23",place:"一般設計学研究所"},[
["H","+","四まで主攻正面は陸側。"],
[["屍者","ゾンビ"],"数百万が誘引されると予測。"],
["H","+","六、仮称リヴァイアサン東京湾に侵入。"],
["H","+","八、巨大群体上陸。"],
...
// index:240
[{speaker:"danu",music:"diana23",place:"一般設計学研究所"},[
["最初の四時間で射耗していい。"],
]],
// index:241
[{speaker:"priest",music:"diana23",place:"一般設計学研究所"},[
...
// index:244
[{speaker:"engineer",music:"diana23",place:"一般設計学研究所"},[
["ケーブルは二階まで引けばいいんだね。"],
...
// index:270
[{speaker:"steven",music:"diana23",place:"一般設計学研究所"},[
["これは手紙。"],
["これは郵便。"],
["これは",["物語","ナラティブ"],"。"],
]],
...
],music:"diana23",place:"一般設計学研究所"},[
["人間が読め。"],
["人間が択べ。"],
["配置を択べ。"],
]],
// index:296
[{speaker:"demeter",jump:308,music:"diana23",place:"一般設計学研究所"},[
["エデンの","園","配置が活性化。"],
[["読取専用","ROM"],"構造物を展開。"],
]],
// index:297
...
// index:298
[{speaker:"alice",music:"diana12",place:"一般設計学研究所"},[
["それが人類の選択だというのならば。"],
["その銃を、かまえろ。"],
]],
// index:299
...
// index:300
[{speaker:"narrator",music:"diana12",place:"一般設計学研究所"},[
["少女の","右掌","に",["解放者","リベレータ"],"。"],
["四十五口径。"],
]],
// index:301
...
// index:302
[{speaker:"danu",music:"diana12",place:"一般設計学研究所"},[
["少尉。"],
["アンタ。"],
["一体いつから——"],
...
// index:307
[{speaker:"narrator",leave:($,ctx)=>{ctx.game.visitedRevelation3 = true;},finish:"credits",music:"diana12",place:"一般設計学研究所"},[
["昭和横濱物語。アリスの",["黙示録","リベレーション"],"。"],
["了。"],
]],
// index:308
...
// index:314
[{speaker:"activist",music:"diana23",place:"一般設計学研究所"},[
["良い報せと悪い報せがある。"],
["良い報せだ。魚人の多数派工作は成功した。"],
...
},music:"diana12",place:"一般設計学研究所"},[
["世界は書きかわるのか。"],
["あるいは、すでに書きかわったのか。"],
]],
// index:324
[{speaker:"demeter",music:"diana12",place:"一般設計学研究所"},[
["えっと、書きかわりつつある、たぶん。"],
...
// index:327
[{speaker:"narrator",music:"diana12",place:"いまではない、いつか"},[
[["予言機械","オラクルマシン"],"から、したたりおちる言葉。"],
["無限のそのさき、予言値は拡散していく。"],
...
// index:331
[{speaker:"narrator",music:"diana12",place:"文芸部部室"},[
["元町の坂のうえ、メサイア会の高校は共学になった。"],
["文芸部の部室。"],
["窓際、透きとおるように白い肌の少女が、ふわりと振りむいて。カラコンをつけたボクなんだけど。"],
]],
// index:332
[{speaker:"alice",music:"diana12",place:"文芸部部室"},[
...
// index:334
[{speaker:"danu",music:"diana12",place:"文芸部部室"},[
["気高き","天の女王だよ。"],
["よろー。"],
["これ中華街の肉まんね。"],
["食べながら話そ。"],
...
// index:335
[{speaker:"narrator",music:"diana12",place:"本牧地区"},[
["米軍",["住宅","ハウス"],"の",["金網","フェンス"],"を眺めながら、ボクたちは肉まんを食べる。"],
]],
// index:336
[{speaker:"alice",music:"diana12",place:"本牧地区"},[
["このセカイでは、本牧は返還されていない。"],
["だから、マイカル本牧は誕生しない。"],
["だから、イオン本牧になることもない。"],
]],
...
// index:338
[{speaker:"danu",music:"diana12",place:"本牧地区"},[
...
[{speaker:"narrator",leave:($,ctx)=>{ctx.game.visitedGospel = true;
  ctx.game.unlockPreview = true;;},finish:"credits",music:"diana12",place:"本牧地区"},[
["昭和横濱物語。スティーブンによる福音書。最終節。"],
["了。"],
]],
// index:341
...
// index:347
[{speaker:"priest",music:"diana12",place:"一般設計学研究所"},[
["困りはしないぞ。"],
["メシア教はそんなに甘い宗教ではない。"],
["他の宗教のことは知らんが、な。"],
]],
// index:348
[{speaker:"narrator",music:"diana12",place:"地球"},[
["人類っぽいものは、不老でなくなった。"],
...
// index:350
[{speaker:"narrator",leave:($,ctx)=>{ctx.game.visitedGenesis = true;},finish:"credits",music:"diana12",place:"地球"},[
...
// index:352
[{speaker:"danu",music:"diana21",place:"文芸部部室"},[
["ねえ、アリス。"],
["パパがいたってことはさ。"],
["アリスには、ママもいたわけだよね。"],
]],
// index:353
[{speaker:"alice",music:"diana21",place:"文芸部部室"},[
["このセカイが道理をわきまえているならば。"],
["そんなことは、期待するべくもないが。"],
]],
// index:354
...
},music:"diana21",place:"文芸部部室"},[
["先輩のお父さんって、フィリップ・マーロウを名乗ってたんでしたっけ。"],
["お母さんも、ダサい",["偽名","ソウルネーム"],"を持ってたんですか","。"],
]],
// index:355
[{speaker:"demeter",jump:357,music:"diana21",place:"文芸部部室"},[
...
// index:358
[{speaker:"demeter",music:"diana21",place:"文芸部部室"},[
["屍都の女王もたいがい。"],
]],
// index:359
[{speaker:"alice",music:"diana21",place:"文芸部部室"},[
...
// index:367
[{speaker:"rosa",start:"preview",music:"diana21",place:"いまではない、いつか"},[
["こちらは、自由ラジオ横濱",["前線","フロント"],"。"],
["ライシャワーが死んだセカイ線、バリケードの裡から、あの山岳",["根拠地","ベース"],"で産まれてしまった子供たちへ。"],
["聴こえてるかな。"],
]],
// index:368
[{speaker:"rosa",music:"diana21",place:"いまではない、いつか"},[
...
// index:371
[{speaker:"narrator",leave:($,ctx)=>{ctx.game.visitedSixtyNine = true;},finish:"title",music:"diana21",place:"いまではない、いつか"},[
