...
["たとえば、——昭和が暴走した。このままでは、終わらない昭和に人類は轢き殺される。"],
["選択肢がある。少女を犠牲に捧げれば人類は救われる。"],
]],
// index:9
...
// index:12
[{speaker:"narrator",music:"vi03"},[
["画面上部の",["システム","SYSTEM"],"ボタンを押すと、システム設定パネルが表示される。もういちど押したら消える。"],
["パネルの下のほうが隠れていたら、スクロール。"],
]],
// index:13
[{speaker:"narrator",music:"vi03"},[
["キミがどこまで読んだかは、暗黙に記憶されている。"],
["爪が折れた三本のテープと、爪が折れていない三本のテープが用意されている。"],
["キミは、明示的に、",["読出","LOAD"],"したり、",["書出","SAVE"],"したりできる。"],
]],
// index:14
[{speaker:"narrator",music:"vi03"},[
[["自動","AUTO"],"再生すると、選択肢が示されるまで、あるいはキミがなんらか入力するまで、順番にテクストと",["音声","ボイス"],"が再生されていく。"],
]],
// index:15
[{speaker:"narrator",music:"vi03"},[
[["高速","SKIP"],"再生も似たようなものだけど、",["音声","ボイス"],"を再生しない。"],
["一フレームに一行ずつ、テクストを書きつらねていく。"],
...
// index:57
[{speaker:"alice",jump:59,music:"diana33"},[
["そうだ。飽きるほど囁かれた噂だ。"],
...
// index:90
[{speaker:"narrator",jump:67,music:"diana19"},[
["神父が歩み去る。"],
...
// index:91
[{speaker:"danu",jump:67,music:"diana19"},[
[["大聖堂","カテドラル"],"は行ったじゃん。"],
]],
// index:92
...
// index:172
[{speaker:"danu",jump:186,music:"diana19"},[
["安心して。"],
...
// index:296
[{speaker:"demeter",jump:308,music:"diana23"},[
["エデンの","園","配置が活性化。"],
[["読取専用","ROM"],"構造物を展開。"],
]],
// index:297
