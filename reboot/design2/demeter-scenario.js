...
// index:14
[{speaker:"narrator",finish:"title",music:"vi03"},[
["良き、終末を。"],
]],
// index:15
...
{choice:["サム・スペード"],action:($,ctx)=>{ctx.game.father = 1;;},barcode:"Sam Spade",label:28},
{choice:["フィリップ・マーロウ"],action:($,ctx)=>{ctx.game.father = 2;;},barcode:"Philip Marlowe",label:28},
{choice:["マイク・ハマー"],action:($,ctx)=>{ctx.game.father = 3;;},barcode:"Mike Hammer",label:28},
],music:"diana33"},[
["年季のはいったガヴァメントだ。"],
["刻印がある。"],
["そうか。そういうことか。"],
...
// index:53
[{speaker:"alice",choices:[
{choice:["ある"],barcode:"Yes ma'am!",label:54},
{choice:["ない"],barcode:"No ma'am!",label:55},
],music:"diana33"},[
["さてと。"],
["スティーブンと呼ばれた人物、あるいは結社の噂を聞いたことがあるか。"],
]],
// index:54
[{speaker:"alice",jump:56,music:"diana33"},[
["そうだ。飽きるほど囁かれた噂だ。"],
...
{choice:["本牧",["大聖堂","カテドラル"]],barcode:"priest",label:65},
{choice:["資源循環局"],barcode:"engineer",label:89},
{choice:["魚人港湾労働組合"],barcode:"activist",label:120},
],when:($,ctx)=>{
if($.priest && $.engineer && $.activist)return 160;
},music:"diana19"},[
["少尉、どこに手紙を届けるの。"],
]],
// index:65
...
// index:87
[{speaker:"narrator",jump:64,music:"diana19"},[
["神父が歩み去る。"],
...
// index:88
[{speaker:"danu",jump:64,music:"diana19"},[
[["大聖堂","カテドラル"],"は行ったじゃん。"],
]],
// index:89
[{speaker:"danu",when:($,ctx)=>{
if($.engineer)return 119;
...
// index:121
[{speaker:"narrator",jump:123,when:($,ctx)=>{
if(ctx.system.unionSetting === "ろうくみ")return 122;
},music:"diana19"},[
["入口のかたわらにベニヤ看板。"],
["角ばった字で、魚人港湾労組。"],
["ポリ塩化ビニル暖簾を、キミはくぐった。"],
...
// index:168
[{speaker:"alice",choices:[
{choice:["熱望"],barcode:"Elvis",label:169},
{choice:["希望"],barcode:"Elpis",label:170},
{choice:["拒否"],label:172},
],music:"diana19"},[
["強制はしない、少尉。"],
["熱望か希望か拒否か、ひとつを択べ。"],
...
// index:169
[{speaker:"danu",jump:183,music:"diana19"},[
["安心して。"],
...
// index:171
[{speaker:"danu",choices:[
{choice:["最熱望"],barcode:"Elvis",label:169},
{choice:["熱望"],barcode:"Elvis",label:169},
{choice:["拒否"],label:172},
],music:"diana19"},[
[["妖精","エルブズ"],"はいるけど。"],
...
{choice:["エデンの園"],action:($,ctx)=>{$.genesis = false;;},barcode:"Garden of Eden",label:293},
{choice:["グライダー",["銃","ガン"]],action:($,ctx)=>{$.genesis = true;;},barcode:"Glider Gun",label:294},
{choice:["択ばない"],label:295},
],music:"diana23"},[
["人間が読め。"],
["人間が択べ。"],
["配置を択べ。"],
...
// index:293
[{speaker:"demeter",jump:305,music:"diana23"},[
["エデンの","園","配置が活性化。"],
[["読取専用","ROM"],"構造物を展開。"],
]],
// index:294
...
// index:351
[{speaker:"demeter",jump:354,when:($,ctx)=>{
if(ctx.game.father === 1)return 352;
if(ctx.game.father === 3)return 353;
},music:"diana21"},[
["先輩のお父さんは、フィリップ・マーロウを名乗っていて。"],
["お母さんも、ソウルネームを持ってたんですか。"],
]],
// index:352
[{speaker:"demeter",jump:354,music:"diana21"},[
...
dialogs:{
"system-reset-system":356,
"system-reset-save":357,
"load-tape-select":358,
"load-tape-tutorial":359,
"load-tape-broken":360,
"load-tape-preview":361,
"load-tape-save1":362,
"load-tape-save2":363,
"load-tape-save3":364,
"load-tape-empty":365,
