...
[endscript]
[ptext layer=message0 x=44 y=426 size=32 face=&tf.gothic color=white name=chara_name_area]
...
[chara_new name=steven storage=dummy.png jname=STEVEN]
...
EVANGELIUM SECUNDUM STEPHANUS verse III[l]
[resetfont]

[bg2 storage=title.png time=1000 wait=false method=vanishIn]
[playbgm storage=sessions_diana_track23.ogg loop=true volume=20]
