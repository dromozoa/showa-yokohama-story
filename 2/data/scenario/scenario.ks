...
菊刀一号作戦は発展的に解消した。[l][r]
#alice
ぶっちゃけ、日米連合[ruby x=-16 text=グランドフリート]艦隊は、マリアナ海溝邀撃漸減作戦に失敗した。[l][r]
#alice
...
#narrator
日米連合[ruby x=-16 text=グランドフリート]艦隊は、最後の戦[ruby x=-16 text=バトルシップ]艦を自沈して東京湾を閉塞した。[l][r]
#narrator
